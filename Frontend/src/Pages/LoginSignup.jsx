...
const LoginSignup = () => {
  ...
  const handleLogin = (userToken) => {
    ...
    // Force a refresh to load user-specific cart data from ShopContext
    ...
    <div className='loginsignup' >
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-fields">
         {state==="Sign Up"?<input name='username' value={formData.username} onChange={changeHandler} type='text' placeholder='Yourname' />:<></>}
